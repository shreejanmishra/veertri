...
export const curriculum = {
  [boards.CBSE]: {
    "Pre-school": {
      ...
      "General Knowledge": generateTopics(
        [
          "Parts of Body",
    ...
    "Class 6": {
      ...
      Computers: generateTopics(
        [
          "Computer Languages",
          "More on Windows 7",
          "Using Mail Merge",
          "Microsoft PowerPoint 2010",
          "Animating Text and Object",
    ...
    "Class 11": {
      ...
      "Business Studies": generateTopics(
        [
      ...
      "Political Science": generateTopics(
        [
      ...
      "Computer Science": generateTopics(
        [
  ...
  [boards.ICSE]: {
    // Placeholder for ICSE structure
    "Class 10": {
      Maths: generateTopics(
        [
  ...
  [boards.IB]: {
    // Placeholder for IB structure
    "Diploma Programme": {
      "Mathematics AA": generateTopics(
        [
          "Number and Algebra",
          "Functions",
  ...
  [boards.MAHARASHTRA]: {
    // Placeholder for Maharashtra Board
    "Class 10": {
      Maths: generateTopics(
        [
          "Linear Equations in Two Variables",
...
export const getContentBySubjectAndClass = (
  ...
  const topics = classData[subject];
  if (!topics) return [];
